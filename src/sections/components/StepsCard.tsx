...
const StepsCard = (props: Props) => {
    ...
    return (
        <>
            <CardSpotlight className="group/spotlight px-10 rounded-md flex justify-center items-center relative border border-neutral-800 bg-black dark:border-neutral-800 h-80 w-96" color={props.color}>
                <div>
                    <div
